...
export CUDALEVEL=cuda13.1
export OPT_CPTCAP=cc90

# Turpan : export MPI_ROOT=/usr/local/nvidia/nvhpc/Linux_aarch64/24.11/comm_libs/11.8/openmpi4/openmpi-4.1.5
export MPI_ROOT=/softs/arm/nvhpc/Linux_aarch64/26.1/comm_libs/mpi/bin/
